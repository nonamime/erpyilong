...
赤龙核心人员具备**十几年**的国内**各行业**的信息化建设经验，主导完成多次从**0-1**的企业级信息化系统**研发、实施和运维**的全生命周期。<br/>
...
|   |   |   |
| ------------ | ------------ | ------------ |
|  **采购模块**  | **收货/质检/入库**  |  **动态实时库存**  |
|  零星采购、一揽子采购、采购计划、合同采购  |  采购入库、采购退货、杂项入库、生产入库  |  多库存组织、库存盘点、库存调拨  |
|  **销售模块**  | **出库**  |  **主数据**  |
| 合同销售、销售计划  | 销售出库、销售退货、杂项出库、生产退货  |  客户、供应商、物料、产品、服务、项目  |
|  **生产预测/生产计划**  |  **车间管理**  |  **权限管理**  |
