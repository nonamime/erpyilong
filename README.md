...
<div style="font-size:22px; font-weight:bold;"> :fa-question-circle: 何须高价</div>
...
【赤龙ERP】具有《**软件著作权登记证书**》，知识产权归**开发者所有**。所有用户必须遵守如下约定，否则对违约者我们将保留诉诸法律的权利！
...
#### - 协议管理
###### 根据协议实现更加灵活的订单生成和验证功能

#### - 采购/销售管理
###### 整合客商、物料数据，实现更加完备的自动化的管控

#### - 库房/出入库管理
###### 与订单集成，实现对库存的实时管理，以及仓库的盘点

#### - 生产制造管理
###### 通过BOM、MPS、MRP、WIP实现计划生产与订单、库存的自动化集成管控

#### - 应收/应付管理
###### 完成应付与应收开票，与订单、出入库实现三单匹配
...
#### - 日记账管理
###### 实现模板生成及手工处理的日记账凭证管理，可与子分类账集成

#### - 总账管理
###### 实现凭证过账、月度年度结账，并自动生成科目余额表，科目明细表、资产负债表等财务报表
